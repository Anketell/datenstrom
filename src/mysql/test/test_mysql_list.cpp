...
NAMESPACE_TEST( mysql, list, should_provide_iterator )
{
...
NAMESPACE_TEST( mysql, list, should_manage_cursor_within_transaction )
{
   ds::db::connection test_db( test_con_str );
...
NAMESPACE_TEST( mysql, list, should_manage_cursor_without_transaction )
{
   ds::db::connection test_db( test_con_str );
